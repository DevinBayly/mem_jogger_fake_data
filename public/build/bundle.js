...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 21, 2, 273);
    			add_location(h3, file, 23, 4, 340);
    			attr_dev(div0, "id", "title");
    			attr_dev(div0, "class", "svelte-1w179kj");
    			add_location(div0, file, 22, 2, 319);
    			add_location(p, file, 26, 4, 391);
    			attr_dev(div1, "id", "summary");
    			attr_dev(div1, "class", "svelte-1w179kj");
    			add_location(div1, file, 25, 2, 368);
    			attr_dev(div2, "id", "optionHolder");
    			attr_dev(div2, "class", "svelte-1w179kj");
    			add_location(div2, file, 20, 0, 247);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ imgSrc, title, summaryText });
    	...
    	return [imgSrc, title, summaryText];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$1, 23, 4, 368);
    			attr_dev(div0, "id", "title");
    			attr_dev(div0, "class", "svelte-1n2jh42");
    			add_location(div0, file$1, 22, 2, 347);
    			attr_dev(div1, "id", "gantt-side");
    			add_location(div1, file$1, 26, 2, 423);
    			attr_dev(div2, "id", "map-side");
    			add_location(div2, file$1, 29, 2, 642);
    			attr_dev(div3, "id", "options");
    			attr_dev(div3, "class", "svelte-1n2jh42");
    			add_location(div3, file$1, 25, 2, 402);
    			attr_dev(div4, "id", "holder");
    			attr_dev(div4, "class", "svelte-1n2jh42");
    			add_location(div4, file$1, 21, 0, 327);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ VisOp: VisOption });
    	return [];
    }
