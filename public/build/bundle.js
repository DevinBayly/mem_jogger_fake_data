...
var app = (function () {
    ...
    const file = "src/overlayVid.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 29, 4, 419);
    			...
    			add_location(video, file, 31, 4, 469);
    			add_location(h2, file, 37, 6, 652);
    			attr_dev(div1, "id", "close");
    			add_location(div1, file, 32, 4, 535);
    			attr_dev(div2, "id", "innerholder");
    			attr_dev(div2, "class", "svelte-f36oss");
    			add_location(div2, file, 30, 2, 442);
    			attr_dev(div3, "id", "vidholder");
    			attr_dev(div3, "class", "svelte-f36oss");
    			add_location(div3, file, 28, 0, 394);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Gant_chart> was created with unknown prop '${key}'`);
    	});
    ...
    class Gant_chart extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { data: 0, buildingData: 1 });
    		...
    		if (/*data*/ ctx[0] === undefined && !("data" in props)) {
    			console_1.warn("<Gant_chart> was created without expected prop 'data'");
    		}

    		if (/*buildingData*/ ctx[1] === undefined && !("buildingData" in props)) {
    			console_1.warn("<Gant_chart> was created without expected prop 'buildingData'");
    		}
    	}
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 59, 2, 1302);
    			attr_dev(div0, "id", "tooltipHolder");
    			add_location(div0, file$1, 58, 0, 1275);
    			attr_dev(svg0, "id", "topaxis");
    			add_location(svg0, file$1, 63, 4, 1377);
    			attr_dev(div1, "id", "topaxisholder");
    			add_location(div1, file$1, 62, 2, 1348);
    			attr_dev(svg1, "id", "main");
    			add_location(svg1, file$1, 67, 4, 1442);
    			attr_dev(div2, "id", "topgraph");
    			add_location(div2, file$1, 66, 2, 1418);
    			attr_dev(svg2, "id", "brushable");
    			add_location(svg2, file$1, 70, 4, 1498);
    			attr_dev(div3, "id", "bottomgraph");
    			add_location(div3, file$1, 69, 2, 1471);
    			attr_dev(div4, "id", "graphs");
    			add_location(div4, file$1, 61, 0, 1328);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	window.onload = async () => {
    		let paulData = await fetch("location_data.json").then(res => res.json());
    	...
    	$$self.$capture_state = () => ({ name, VidOverlay: OverlayVid, d3, Gant: Gant_chart });
