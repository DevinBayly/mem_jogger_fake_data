    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$1, 26, 4, 434);
    			attr_dev(div0, "id", "title");
    			attr_dev(div0, "class", "svelte-k1anbt");
    			add_location(div0, file$1, 25, 2, 413);
    			attr_dev(div1, "id", "gantt-side");
    			add_location(div1, file$1, 29, 2, 489);
    			attr_dev(div2, "id", "map-side");
    			add_location(div2, file$1, 32, 2, 706);
    			attr_dev(div3, "id", "options");
    			attr_dev(div3, "class", "svelte-k1anbt");
    			add_location(div3, file$1, 28, 2, 468);
    			attr_dev(div4, "id", "holder");
    			attr_dev(div4, "class", "svelte-k1anbt");
    			add_location(div4, file$1, 24, 0, 393);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
